...
def scatterplot():
    ...
    st.write("<h4 style = 'text-align : center;'> Scatter plot between predicted and true values</h4>",unsafe_allow_html=True)
    st.write(fig)
...
def line_chart():
    ...
    plt.legend()
    st.write("<h4 style = 'text-align : center;'> Line chart of true vs predicted vales</h4>",unsafe_allow_html=True)
    st.pyplot(fig)
    add_vertical_space(2)
    st.write("---")
...
def histogram():
    ...
    st.write("<h4 style = 'text-align : center;'> Histogram of predicted values</h4>",unsafe_allow_html=True)
    st.pyplot(fig)
    add_vertical_space(2)
    st.write("---")
...
def show_results():
    ...
    if (session_state.model_type == "Regression model"):
        st.write("<h4 style = 'text-align : center;'> Evaluation metrics</h4>",unsafe_allow_html=True)
